...
def main():
    ...
    parser.add_argument("--steps", type=int, default=35000, help="Maximum simulation steps per radius.")
    parser.add_argument("--stride", type=int, default=90, help="Animation frame stride.")
